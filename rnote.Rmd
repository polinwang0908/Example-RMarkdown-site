...
- **Law of Large Number**: 
$$ \text{For any small }\epsilon>0, Pr(|\frac{L_1+L_2+...+L_N}{N}-\mu<\epsilon|)\rightarrow1 \text{ as } N\rightarrow \infty $$
...
Given two unbiased estimators of $\theta$, an estimator $W_1$ is efficient relative to $W_2$ if $Var(W1)\leq Var(W2) \forall \theta$
...
As sample size $n\rightarrow \inf$, $P(\mid W_n-\theta\mid>\epsilon)\rightarrow 0$ 
